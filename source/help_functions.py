...
def generate_csv(data_path: str,SampleList: list):
    ...
    for sample in SampleList:
        ...
        my_dict['ins_del_ratio_ratio_by_eventful_UMI']=[ins_del_ratio_ratio_by_eventful_UMI]
...
def analyze_allele_frequency_count(data_path: str, SampleList: list):
    ...
    df_new = df_raw.groupby("allele", as_index=False).agg({"UMI_count": "sum","sample_count": "sum"})
    ...
    ax=sns.scatterplot(data=df_count.reset_index(),x='UMI_count',y='Frequency',edgecolor='k',color='#d7191c')
